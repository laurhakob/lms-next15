...
//       <Card className="mb-2 border border-[#195a5a]/10 bg-white/80 shadow-sm rounded-md overflow-hidden transition-all duration-300 hover:shadow-md">
//         <CardHeader className="bg-gradient-to-r from-[#d1e8d5] to-[#b3d9b9] p-3">
//           <div className="flex items-center justify-between">
//             <CardTitle className="text-lg font-semibold text-[#195a5a]">{lesson.title}</CardTitle>
//             <Button
//               variant="destructive"
//               size="icon"
...
//   const [view, setView] = useState<"basic" | "structure">("structure");
