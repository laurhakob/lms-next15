...
//                       <Card key={chapter._id} className="border border-[#195a5a]/20 bg-white/80 shadow-md rounded-xl flex items-center p-4 transition-all duration-300 hover:shadow-lg">
